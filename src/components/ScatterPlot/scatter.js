$.get("data/TPTNFPFNdata.json", function(data){
    ...
    for(i=0;i<data.TPx.length;i++){
        TPdata.push([data.TPx[i],data.TPy[i],data.TPsid[i]])       
    }
    for(i=0;i<data.TNx.length;i++){
        TNdata.push([data.TNx[i],data.TNy[i],data.TNsid[i]])       
    }
    for(i=0;i<data.FPx.length;i++){
        FPdata.push([data.FPx[i],data.FPy[i],data.FPsid[i]])       
    }
    for(i=0;i<data.FNx.length;i++){
        FNdata.push([data.FNx[i],data.FNy[i],data.FNsid[i]])       
    }
    // var data = [
